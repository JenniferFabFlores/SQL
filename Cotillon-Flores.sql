...
CREATE TABLE Producto (
  ...
  categoria VARCHAR(50),                        -- categoría (ej: globos, decoraciones)
  precio_unitario DECIMAL(10,2) NOT NULL,      -- precio por unidad
  stock_actual INT NOT NULL DEFAULT 0          -- stock disponible en inventario
);
...
CREATE TABLE Detalle_Venta (
  ...
  precio_unitario DECIMAL(10,2) NOT NULL,        -- precio por unidad en esa venta
...
CREATE TABLE Compra (
  ...
  total_compra DECIMAL(10,2) NOT NULL,             -- monto total pagado
...
CREATE TABLE Detalle_Compra (
  ...
  precio_unitario DECIMAL(10,2) NOT NULL,            -- precio pagado por unidad
